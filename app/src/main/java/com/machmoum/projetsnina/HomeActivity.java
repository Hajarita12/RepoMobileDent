...
public class HomeActivity extends Activity implements View.OnClickListener{
    ...
    private TextView  anglesTextView,anglesTextView2;
    private List<Point> selectedPoints = new ArrayList<>();
...
// Affichage des angles dans le TextView
            anglesTextView.setText("Angle gauche (dépouille) : " + angleGauche + " degrés\n");
    ...
    public void onClick(View v) {
        String url = "http://128.10.6.63:8088/etudiant/saveStudentPW";
        try {
